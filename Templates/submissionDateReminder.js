...
export function submissionReminderTemplate(projectName, submissionDate, recipientUsername) {
    ...
    <div class="email-container">
        <div class="header-flex">
            <div class="header-title">
                <span>Project Submission Reminder</span><br/>
        ...
        <div class="email-body">
            ...
            <p>This is a friendly reminder about the upcoming **submission deadline** for your project on Project Station.</p>

            <p><strong>Project Name:</strong> ${projectName}</p>
            <p><strong>Scheduled Submission Date:</strong> <span class="green-text">${formattedDate}</span></p>

            <p>Please ensure all necessary materials and documentation are finalized and submitted by this date. You can review all project details and update the status by clicking the link below:</p>
            ...
            <p style="margin-top: 30px;">If this project has already been submitted, please update its status on Project Station to prevent further reminders.</p>
